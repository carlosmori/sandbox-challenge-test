export const DOGGIES_ABI = [
  {
    inputs: [
      { internalType: "string", name: "baseURI", type: "string" },
      { internalType: "string", name: "_name", type: "string" },
      { internalType: "string", name: "_symbol", type: "string" },
      { internalType: "address payable", name: "_sandOwner", type: "address" },
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "_wallet", type: "address" },
      { internalType: "uint256", name: "_signatureId", type: "uint256" },
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_waveType", type: "uint256" },
      { internalType: "uint256", name: "_waveMaxTokens", type: "uint256" },
      { internalType: "uint256", name: "_waveMaxTokensToBuy", type: "uint256" },
      {
        internalType: "uint256",
      ...
      { internalType: "address", name: "_contractAddress", type: "address" },
      { internalType: "uint256", name: "_erc1155Id", type: "uint256" },
    ],
    name: "setupWave",
    outputs: [],
    stateMutability: "nonpayable",
